...
TASK_MAPPING = {
    ...
    14: {
        "task_topic": ["системы счисления","кодирование чисел"],
        "task_detail": ["вычислить частное", "найти количество значений", "определить произведение", 
        "определить значение выражения", "определить разность", "посчитать сколько цифр", "найти сумму", "найти число"],
        "task_number_14": True
    },
    15: {
        "task_topic": ["логические выражения","побитовая конъюнкция", "числовые отрезки", "координатная плоскость"],
        "task_detail": ["определить число", "определить длину", "найти количество значений"],
        "task_number_15": True
    },
    16: {
        "task_topic": ["рекурсия"],
        "task_detail": ["найти значение функции", "найти число в последовательности", "определить значение выражения"],
        "task_number_16": True
    },
    17: {
